...
// - name 속성 : 매핑할 RDBMS의 테이블 명을 지정
// - 만약, 클래스명 - Entity명 - Table 명이 동일하면 생략 가능
@Table(name = "student")
public class StudentEntity {
    ...
    @Id
    // @GeneratedValue : 
    // - Primary Key의 자동 생성 전략을 지정 (db에서 auto_increment 같은 속성 지정할때 )
    //  ex) AUTO : JPA가 적절한 생성 전략을 선택
