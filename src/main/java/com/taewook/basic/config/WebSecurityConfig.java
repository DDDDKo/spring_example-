...
import com.taewook.basic.provider.OAuth2SuccessHandler;
import com.taewook.basic.service.implement.OAuth2UserServiceImplement;
...
public class WebSecurityConfig {
    ...
    private final OAuth2UserServiceImplement oAuth2UserServiceiImplement;
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        .oauth2Login(oauth2 -> oauth2
            ...
            .userInfoEndpoint(endpoint -> endpoint.userService(oAuth2UserServiceiImplement))
    ...
    protected CorsConfigurationSource corsConfigurationSource() {
        ...
        // 모든 메서드에 대해서 허용 get, post
        configuration.addAllowedMethod("*");
        // 모든 출처에 대해서 허용
        configuration.addAllowedOrigin("*");
        // 모든 헤더에 대해서 허용 헤더에 무슨 값이 오던 허용
